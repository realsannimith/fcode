...
CTCode is a local-first desktop app for coding with the AI agents and subscriptions you already use.
...
![CTCode app showing parallel agent threads, terminal output, and project navigation](assets/prod/readme-screenshot.jpeg)
...
- Keep your workspace local. CTCode stores chats, projects, and history on your machine and talks directly to the providers you choose.
