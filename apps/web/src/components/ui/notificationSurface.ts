...
import { APP_TRANSLUCENT_POPUP_SURFACE_CLASS_NAME } from "./floatingSurfaceStyles";
...
// Expanded notifications share the exact surface chrome used by quick-action
// menus. Reusing the token keeps their neutral color, compact radius, border,
// blur, and shadow aligned instead of maintaining a toast-only approximation.
export const EXPANDED_NOTIFICATION_SURFACE_CLASS_NAME = `w-full ${APP_TRANSLUCENT_POPUP_SURFACE_CLASS_NAME} ${NOTIFICATION_FOREGROUND_CLASS_NAME} [-webkit-app-region:no-drag]`;
