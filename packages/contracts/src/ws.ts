...
export const WS_METHODS = {
  ...
  serverCodexAccountLogin: "server.codexAccountLogin",
  serverCodexAccountLoginCancel: "server.codexAccountLoginCancel",
  serverCodexAccountLogout: "server.codexAccountLogout",
...
const WebSocketRequestBody = Schema.Union([
  ...
  tagRequestBody(WS_METHODS.gitDiscoverRepositories, GitDiscoverRepositoriesInput),
  ...
  tagRequestBody(WS_METHODS.serverCodexAccountLogin, ServerCodexAccountAuthInput),
  tagRequestBody(WS_METHODS.serverCodexAccountLoginCancel, ServerCodexAccountAuthInput),
  tagRequestBody(WS_METHODS.serverCodexAccountLogout, ServerCodexAccountAuthInput),
